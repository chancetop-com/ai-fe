  ...
  if (!isContainer) {
    return (
      <div className="group flex items-baseline gap-1 leading-6" style={indent}>
        ...
        {!isLast ? <span style={{ color: 'var(--color-text-muted)' }}>,</span> : null}
  ...
  return (
    <div className="group leading-6" style={indent}>
      <div className="flex items-center gap-1 select-none">
        ...
        {!isLast && !expanded ? <span style={{ color: 'var(--color-text-muted)' }}>,</span> : null}
...
export default function JsonTreeView({
  ...
  if (!parsed.ok) {
    return (
      <div className="px-4 py-3 text-xs" style={{ color: 'var(--color-error)' }}>
        ...
        <pre
          className="whitespace-pre-wrap font-mono p-2 rounded"
          style={{
  ...
  return (
    <div className="font-mono text-xs px-4 py-3" style={{ color: 'var(--color-text)', lineHeight: '1.6' }}>
      {showHeader ? (
        <div
          className="flex items-center gap-2 pb-2 mb-2 border-b text-xs"
